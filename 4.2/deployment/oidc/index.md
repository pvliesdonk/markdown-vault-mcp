...
The Auth Modes table above states what each mode needs. For why remote is the better default here, and how to move an existing oidc-proxy deployment to it, see [Choosing an OIDC mode](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/guides/authentication/#choosing-an-oidc-mode).
