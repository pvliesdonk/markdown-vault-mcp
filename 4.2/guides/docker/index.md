...
See [Docker deployment](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/deployment/docker/#uidgid-configuration) for more options.
...
For more details on bearer token auth (client usage, when to use it), see the [Authentication guide](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/guides/authentication/#bearer-token).
...
- [Authentication guide: OIDC section](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/guides/authentication/#oidc): overview and variable reference
- [OIDC provider setup](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/guides/oidc-providers/index.md): step-by-step for Authelia, Keycloak, Google, GitHub
- [OIDC deployment reference](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/deployment/oidc/index.md): Docker Compose, subpath config, architecture
...
For full details on the views and architecture, see the [MCP Apps guide](https://pvliesdonk.github.io/markdown-vault-mcp/4.2/guides/mcp-apps/index.md).
