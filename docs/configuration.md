...
| `MARKDOWN_VAULT_MCP_BASE_URL` | url | — | Public base URL of the server (e.g. `https://mcp.example.com`). Required for OIDC auth and MCP Apps domain computation; the `create_download_link` tool reuses it to build URLs |
