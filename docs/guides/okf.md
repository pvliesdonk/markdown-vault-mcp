...
- **Type**: the free-text `type` field (for example `Playbook`, `Metric`, `Reference`).
...
OKF composes with the [PARA](para.md) and [Zettelkasten](zettelkasten.md) methodologies. They organise where notes live and how work flows; OKF describes what each note is. A PARA or Zettelkasten vault can also be an OKF bundle. Three points of overlap are worth noting:
