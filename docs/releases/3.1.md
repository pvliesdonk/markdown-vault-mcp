...
([#720](https://github.com/pvliesdonk/markdown-vault-mcp/issues/720)) that the
scoped-watch work here reintroduced and
[#830](https://github.com/pvliesdonk/markdown-vault-mcp/issues/830) fixed
again, and [@Denzilla04](https://github.com/Denzilla04) reported the
escaped-pipe wikilinks
([#731](https://github.com/pvliesdonk/markdown-vault-mcp/issues/731)). Both
fixes shipped in the 3.0 patch line and are credited on the
[3.0 page](3.0.md#patch-releases).
