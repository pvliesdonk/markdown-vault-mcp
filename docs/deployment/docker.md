...
nothing, and `/etc/markdown-vault-mcp/env` carries the choice.

`MARKDOWN_VAULT_MCP_LOG_LEVEL` sets how much is logged; see [Configuration](../configuration.md#logging).
