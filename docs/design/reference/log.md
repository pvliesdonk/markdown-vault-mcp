...
- `obsidian-markdown.md`: the `.md`-append and embed entries updated for #1333 (attachment references are not links; note embeds still are); the departure recorded as a deliberate notes-only carve-out pointing at #1359; test pins added.
