    ...
    okf_verify: str = field(
        ...
        metadata={
            "help": (
                ...
                "trust-auth instead to attribute to a token's sub claim with no "
                "confirmation; it rejects static bearer credentials and other "
                "client-ID-only identities. This is safe only when the sole "
