"""Text normalization and fuzzy matching utilities for file editing.

These helpers support the "edit" tool by allowing fuzzy matching of text
blocks (handling whitespace differences and smart-quote normalization)
while preserving the exact byte-for-byte original content for the
replacement step.
"""
