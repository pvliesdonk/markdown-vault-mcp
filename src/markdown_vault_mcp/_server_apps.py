...
def register_apps(mcp: FastMCP) -> None:
    ...
    @mcp.tool(
        ...
        meta=_fastmcp4_app_tool_meta(_APP_NAME, "vault_context"),
        app=AppConfig(resource_uri=_APP_URI, visibility=["app"]),
    )
    ...
    @mcp.tool(
        ...
        meta=_fastmcp4_app_tool_meta(_APP_NAME, "vault_graph_neighborhood"),
        app=AppConfig(resource_uri=_APP_URI, visibility=["app"]),
    )
    ...
    @mcp.tool(
        ...
        meta=_fastmcp4_app_tool_meta(_APP_NAME, "vault_graph_hubs"),
        app=AppConfig(resource_uri=_APP_URI, visibility=["app"]),
    )
    ...
    @mcp.tool(
        ...
        meta=_fastmcp4_app_tool_meta(_APP_NAME, "vault_list"),
        app=AppConfig(resource_uri=_APP_URI, visibility=["app"]),
    )
    ...
    @mcp.tool(
        ...
        meta=_fastmcp4_app_tool_meta(_APP_NAME, "vault_read"),
        app=AppConfig(resource_uri=_APP_URI, visibility=["app"]),
    )
    ...
    @mcp.tool(
        ...
        meta=_fastmcp4_app_tool_meta(_APP_NAME, "vault_search"),
        app=AppConfig(resource_uri=_APP_URI, visibility=["app"]),
    )
