...
class TestPromotedPublicSurface:
    """The members ``_tools/git.py`` used to reach for privately."""
...
class _FakeSyncer:
    ...
    def set_commit_observer(self, observer: Any) -> None: ...
...
class TestManagedGateAcceptsAnySyncer:
    ...
    def test_fake_syncer_passes_the_managed_gate(self) -> None:
        ...
        """
        from markdown_vault_mcp._tools.git import _resolve_managed_strategy
