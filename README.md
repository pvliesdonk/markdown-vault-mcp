...
|---|---|---|---|
| `MARKDOWN_VAULT_MCP_SOURCE_DIR` | `/data/vault` | No | Path to the markdown vault directory. Required: the server refuses to start when it is unset or the directory does not exist (managed git mode clones into it). Symbolic links inside the vault are followed on Python 3.13+. |
