...
- See [Configuration](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/configuration/index.md) for all available env vars, including git write support and semantic search options
- See [Claude Desktop](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/guides/claude-desktop/index.md) if you also use Claude Desktop with the same vault
