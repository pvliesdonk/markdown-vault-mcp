...
Use the [Configuration Generator](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/configuration-generator/index.md) to answer a few questions and copy a ready-made `.env`, Docker, or Claude config.
...
Optional token-based authentication for HTTP deployments. OIDC activates when all four required variables are set. See [OIDC deployment](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/deployment/oidc/index.md) for setup details.
