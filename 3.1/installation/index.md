...
See [Docker deployment](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/deployment/docker/index.md) for compose setup and volume configuration.
...
See the [systemd deployment guide](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/deployment/systemd/index.md) for full configuration and troubleshooting.
...
See the [Claude Code plugin guide](https://pvliesdonk.github.io/markdown-vault-mcp/3.1/guides/claude-code-plugin/index.md) for configuration and usage details.
