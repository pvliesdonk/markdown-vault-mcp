...
- [Authelia](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/guides/oidc-providers/#authelia)
- [Keycloak](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/guides/oidc-providers/#keycloak)
- [Google](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/guides/oidc-providers/#google)
- [GitHub (via Keycloak broker)](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/guides/oidc-providers/#github)

For the full OIDC reference (env vars, Docker Compose, subpath deployments, architecture):

- [OIDC Authentication reference](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/deployment/oidc/index.md)
...
- For subpath deployments, see the [subpath deployment guide](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/deployment/oidc/#subpath-deployments): `BASE_URL` must include the prefix, `HTTP_PATH` must not
...
See the [Authelia provider guide](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/guides/oidc-providers/#authelia) for the full configuration.

### Opaque access tokens (Authelia)

Authelia issues opaque (non-JWT) access tokens. This is handled automatically: the server verifies the `id_token` instead. No extra configuration needed. See the [Authelia guide](https://pvliesdonk.github.io/markdown-vault-mcp/5.0/guides/oidc-providers/#authelia) for details.
