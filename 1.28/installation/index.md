...
See [Docker deployment](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/deployment/docker/index.md) for compose setup and volume configuration.
...
See the [systemd deployment guide](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/deployment/systemd/index.md) for full configuration and troubleshooting.
...
See the [Claude Code plugin guide](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/guides/claude-code-plugin/index.md) for configuration and usage details.
