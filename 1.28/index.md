...
- **"Research and create a set of interlinked notes."** Claude composes web tools + `write` with wikilinks. See the [Research workflows guide](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/guides/research-workflows/index.md) for the full loop.
- **"Summarize today's conversations into Inbox notes."** Claude.ai composes `conversation_search` + `recent_chats` + `write`; the [`para-capture-chats`](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/guides/para/#using-the-para-prompts) prompt is the one-click version.
- **Find missing links.** The [`propose-links`](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/prompts/index.md) builtin prompt scans recently-modified notes and proposes meaningful connections.

See [MCP Prompts](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/prompts/index.md) for the codified workflows and the ambient-pattern reference.
...
See [Installation](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/installation/index.md) for all installation methods (PyPI, uv, Docker, Linux packages, Claude Code plugin) and [Configuration](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/configuration/index.md) for all available options.
