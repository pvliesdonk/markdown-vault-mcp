...
Optional token-based authentication for HTTP deployments. OIDC activates when all four required variables are set. See [OIDC deployment](https://pvliesdonk.github.io/markdown-vault-mcp/1.28/deployment/oidc/index.md) for setup details.
