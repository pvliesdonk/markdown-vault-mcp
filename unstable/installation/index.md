...
See the [systemd deployment guide](https://pvliesdonk.github.io/markdown-vault-mcp/unstable/deployment/systemd/index.md) for full configuration and troubleshooting.
...
See the [Claude Code plugin guide](https://pvliesdonk.github.io/markdown-vault-mcp/unstable/guides/claude-code-plugin/index.md) for configuration and usage details.
