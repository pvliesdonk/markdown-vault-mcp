...
- **Find missing links.** The [`propose-links`](https://pvliesdonk.github.io/markdown-vault-mcp/unstable/prompts/index.md) builtin prompt scans recently-modified notes and proposes meaningful connections.
