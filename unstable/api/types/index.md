...
| `updated_links` | `int` | Number of source documents whose links were actually rewritten. A source the rewrite left byte-identical is not counted, because it still names the old path (#1521). |
| `hint`          | \`str | None\`                                                                                                                                                                |
