...
Edit `/etc/markdown-vault-mcp/env` — this is the `EnvironmentFile` loaded by the systemd unit. The example file at `/etc/markdown-vault-mcp/env.example` documents all available variables.
